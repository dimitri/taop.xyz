...
return one row per input row — so you can rank, compare to neighbours, and
compute running totals without losing the detail rows you started with. These
lessons cover the fundamentals through advanced analytical patterns.
